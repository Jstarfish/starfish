...
public class EncodeUtil {
	...
	public static String encodeHexOneStep(byte[] input, byte[] salt) {
		byte[] hashValue = DigestUtil.sha1(input, salt, HASH_INTERATIONS);
		return EncodeUtil.encodeHex(hashValue);
	}
