...
public class AlipayNotify {
    ...
    public static boolean verifyMobile(Map<String, String> params) {
	    ...
	    String sign = "";
	    if(params.get("sign") != null) {sign = params.get("sign");}
	    boolean isSign = getSignVeryfyMobile(params, sign);
	...
	private static boolean getSignVeryfyMobile(Map<String, String> Params, String sign) {
    	//过滤空值、sign与sign_type参数
    	Map<String, String> sParaNew = AlipayCore.paraFilter(Params);
        //获取待签名字符串
        String preSignStr = AlipayCore.createLinkString(sParaNew);
        //获得签名验证结果
        boolean isSign = false;
        if(AlipayConfig.sign_type_mobile.equals("RSA")){
    ...
    */
    private static String verifyResponse(String notify_id) {
        ...
        String checkUrl = checkUrl(veryfy_url);
        System.out.println("*************验证结果集******************");
