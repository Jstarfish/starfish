...
public class UnionpayBase {
	...
	public static String frontUrl = "http://172.18.137.63:8080/ACPSample_WuTiaoZhuan/frontRcvResponse";

	//后台服务对应的写法参照 BackRcvResponse.java
	public static String backUrl = "http://222.222.222.222:8080/ACPSample_WuTiaoZhuan/BackRcvResponse";//受理方和发卡方自选填写的域[O]--后台通知地址
