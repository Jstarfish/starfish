...
(function ($) {
	...
	var default_options  = {
        ...
        showYearOrder: "asc"// asc升序排列，desc降序排列//by gyn*
	};
	// fix for ie8
			...
			datetimepicker
				.on('xchange.xdsoft', function (event) {
					...
					xchangeTimer = setTimeout(function () {
						...
						opt = '';
						i = 0;
						var showYearOrder = options.showYearOrder;
						if(showYearOrder.toLowerCase() == "desc"){
							for (i = parseInt(options.yearEnd, 10) + options.yearOffset; i >= parseInt(options.yearStart, 10) + options.yearOffset; i -= 1) {
