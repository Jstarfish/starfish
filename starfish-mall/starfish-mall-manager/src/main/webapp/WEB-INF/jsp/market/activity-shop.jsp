		...
		<div class="filter section">
			<div class="filter row">
				<div class="group right aligned">
					...
					<label class="label one wide" style="display: none">发送对象</label>
					<select class="input one wide" id="dataFlag" style="display: none"></select></span>
			...
			activityGridCtrl= $id("activityGridCtrl").jqGrid({
			      ...
			      colModel : [{
							...
							},
							{
								...
								index : 'id',
								formatter : function(cellValue, option, rowObject) {
									return activity = "[<a class='item' href='javascript:void(0);' onclick='openShowDlg(" + cellValue + ")' >查看</a>]<span class='chs spaceholder'></span>";
								},
								width : 200,
								align : "center"
							}],  
