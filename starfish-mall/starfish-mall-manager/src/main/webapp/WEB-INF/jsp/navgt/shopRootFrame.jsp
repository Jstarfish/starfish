...
<html>
	...
	<body id="rootPanel">
		<div id="topPanel" class="ui-layout-north" style="padding: 0;height:80px;">
			...
			<tr>
				<td rowspan="2" class="align middle" width="640">
					<img id="scopeLogoImg" src="<%=resBaseUrl%>/image/logo.png" style="float:left;margin-left:10px;"  width="135" height="50"/>
					<span id="scopeEntityName" style="float:left;margin-left:30px;margin-top:10px;font-size: 22px;color: #FFF;">店铺后台管理</span>
				</td>
				<td width="80%">
					<div class="statusBar">
						<span id="loginStatus" style="display: inline-block; ">当前用户：<span id="userName"></span></span>
		...
		<script type="text/javascript">
			...
			$(function() {
				...
				$id("userSetting").click(function(){
					var frameInfo = {
						id : "module-userInfo",
						src : getAppUrl("/shop/personal/info/jsp")
					};
					framesMgr.open(frameInfo);
					//
