...
@Table(name = "biz_param", uniqueConstraints = { @UniqueConstraint(fieldNames = { "name" }) })
public class BizParam implements Serializable, XParam {
	...
	public String toString() {
		return "BizParam [code=" + code + ", name=" + name + ", type=" + type + ", value=" + value + ", desc=" + desc + ", seqNo=" + seqNo + ", ts=" + ts + "]";
	}
